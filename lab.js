...
while (z > 0){   //Start of the loop
  for (let i = z; i > 0; i--){    //the count down 
    console.log(i);
  }
  z--   //the decrement of the starting point
}